...
def build():
    ...
    ldflags_parts = [
        ...
        f"-X main.GatewayID={os.environ['FJ_GATEWAY_ID']}",
        ...
        f"-X main.StreamName={os.environ['FJ_STREAM']}",
        f"-X main.ConsumerName={os.environ['FJ_CONSUMER']}",
        f"-X main.InboxPrefix={os.environ['FJ_INBOX_PREFIX']}",
        f"-X main.ObjectStoreName={os.environ['FJ_OBJECT_STORE']}",
